...
cake01 = SpecialCake('Vanilla Cake', 'cake', 'vanilla', ['chocolate', 'nuts'], 'cream', 'birthday',
                     'round', None, 'Happy Birthday')
cake02 = SpecialCake('Lemon Cake', 'cake', 'vanilla', ['chocolate', 'nuts'], 'cream', 'wedding',
                     'round', None, 'Happy Wedding')
